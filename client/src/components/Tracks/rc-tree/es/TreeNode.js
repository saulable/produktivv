...
var TreeNode = (function(_React$Component) {
	...
	function TreeNode(props) {
		...
		var _this = _possibleConstructorReturn(
			this,
			(TreeNode.__proto__ || Object.getPrototypeOf(TreeNode)).call(this, props)
		);
		...
		},
		{
			...
			value: function render() {
				...
				var _context$rcTree = this.context.rcTree,
					...
					draggable =
						this.props.draggable === false ? false : _context$rcTree.draggable;

				var disabled = this.isDisabled();
				var dataOrAriaAttributeProps = Object.keys(otherProps).reduce(function(
					prev,
					key
				) {
...
var _initialiseProps = function _initialiseProps() {
	...
	this.renderSwitcher = function() {
		...
		if (_this2.isLeaf()) {
			return React.createElement(
				...
				typeof switcherIcon === 'function'
					? React.createElement(
						switcherIcon,
						_extends({}, _this2.props, { isLeaf: true })
					  )
					: switcherIcon
			);
		}
		...
		return React.createElement(
			...
			typeof switcherIcon === 'function'
				? React.createElement(
					switcherIcon,
					_extends({}, _this2.props, { isLeaf: false })
				  )
				: switcherIcon
		);
	};
	...
	this.renderSelector = function() {
		...
		var title = _props6.title,
			...
			handleBlur = _props6.handleBlur,
			handleKeyPress = _props6.handleKeyPress,
			ref = _props6.thisRef,
			icon = _props6.icon,
			...
			$icon = currentIcon
				? React.createElement(
					...
					typeof currentIcon === 'function'
						? React.createElement(currentIcon, _extends({}, _this2.props))
						: currentIcon
				  )
				: _this2.renderIcon();
